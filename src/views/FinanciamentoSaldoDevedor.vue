                    ...
                    <section class="card border-0 py-1 p-md-2 p-xl-3 p-xxl-4">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center mt-sm-n1 mb-0 mb-lg-1 ">
                                <h2 class="h4 mb-0">Cálculo de saldo devedor</h2>
                            </div>
                            <br>
                            ...
                            <div style="display: flex; justify-content: center;">
                                ...
                                <table class="tab1">
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="amortizacao" v-model="amortizacao" id="amortizacao"
                                                value="s"><label for="amortizacao">&nbsp;Digitar amortização / parcelas do financiamento:</label></td>
                                        <td>
                                            <table class="tab2">
                                                <tr>
                                                    <td>Data do vencimento:</td>
                                                ...
                                                <tr v-for="num in numAmortizacoes" :key="num">
                                                    <td>
                                                        <input class="form-control" type="text" :id="'amortizacao_dia['+num+']'"
                                                            :name="'amortizacao_dia['+num+']'" :v-model="'amortizacao_dia['+num+']'"
                                                            @input="formatacaoData" maxlength="10">
                                                    </td>

                                                    <td>
                                                        <input class="form-control" type="text" :id="'amortizacao_valor['+num+']'"
                                                            :name="'amortizacao_valor['+num+']'" :v-model="'amortizacao_valor['+num+']'"
                                                            @input="formatacaoMoeda">
                                                    </td>
                                            ...
                                            <br>
                                            <button class="btn btn-primary" style="height: 35px;" @click="numAmortizacoes++">Adicionar Linha</button>
                                        </td>
                                    </tr>
