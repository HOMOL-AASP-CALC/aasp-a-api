...
module.exports = {
    montaTabela: function (tabela, options) {
        return 'teste'
    },
    calculosJudiciais:  async function (d, calc) {
        ...
        valoresList.rows.push([formatacao3, '', 'A', 'B', 'C = A x B', 'D', 'E = C x D', 'F', 'G = (C + E) x F', 'H = C + E + G' ])
        ...
        let res = '<html><head><meta charset="utf-8"><title>Cálculos</title></head><body>'

        res += 'RESUMO E TOTALIZAÇÃO DO CÁLCULO' 
        ...
        res +=  montaTabela(resumoTotalizacao, { width: 185, rowSpacing: 1,paddingLeft:5, paddingTop:3, paddingBottom:4, columnSpacing:15, rowSpacing:6 });
